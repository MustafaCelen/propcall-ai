// AES-256-GCM envelope encryption — Vapi/ElevenLabs API key'leri için
...
function getMasterKey(): Buffer {
  ...
  if (!raw) throw new Error('SECRET_ENCRYPTION_KEY tanımlanmamış — 32 byte base64');
...
// Utility — dev/setup için yeni master key üretir
